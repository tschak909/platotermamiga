...
#define MUTUALEXCLUDE_BAUD_MENU   9    // Baud rate radio
...
struct MenuItem item115200 =
  { NULL, 0, 96, WIDTH_BAUD_MENU_ITEM, HEIGHT_ITEM, ITEMTEXT|ITEMENABLED|HIGHCOMP, MUTUALEXCLUDE_BAUD_MENU, &text115200, &text115200, NULL,    NULL, 0 };

struct IntuiText text57600 = 
  { 0, 1, JAM2, CHECKWIDTH, TOP_TEXT_ITEM, NULL, "57600", NULL };

struct MenuItem item57600 =
  { &item115200, 0, 84, WIDTH_BAUD_MENU_ITEM, HEIGHT_ITEM, ITEMTEXT|ITEMENABLED|HIGHCOMP, MUTUALEXCLUDE_BAUD_MENU, &text57600, &text57600, NULL,    NULL, 0 };

struct IntuiText text38400 = 
  { 0, 1, JAM2, CHECKWIDTH, TOP_TEXT_ITEM, NULL, "38400", NULL };

struct MenuItem item38400 =
  { &item57600, 0, 72, WIDTH_BAUD_MENU_ITEM, HEIGHT_ITEM, ITEMTEXT|ITEMENABLED|HIGHCOMP, MUTUALEXCLUDE_BAUD_MENU, &text38400, &text38400, NULL,    NULL, 0 };

struct IntuiText text19200 = 
  { 0, 1, JAM2, CHECKWIDTH, TOP_TEXT_ITEM, NULL, "19200", NULL };

struct MenuItem item19200 =
  { &item38400, 0, 60, WIDTH_BAUD_MENU_ITEM, HEIGHT_ITEM, ITEMTEXT|ITEMENABLED|HIGHCOMP, MUTUALEXCLUDE_BAUD_MENU, &text19200, &text19200, NULL,    NULL, 0 };

struct IntuiText text9600 = 
  { 0, 1, JAM2, CHECKWIDTH, TOP_TEXT_ITEM, NULL, "9600", NULL };

struct MenuItem item9600 =
  { &item19200, 0, 48, WIDTH_BAUD_MENU_ITEM, HEIGHT_ITEM, ITEMTEXT|ITEMENABLED|HIGHCOMP, MUTUALEXCLUDE_BAUD_MENU, &text9600, &text9600, NULL,    NULL, 0 };

struct IntuiText text4800 = 
  { 0, 1, JAM2, CHECKWIDTH, TOP_TEXT_ITEM, NULL, "4800", NULL };

struct MenuItem item4800 =
  { &item9600, 0, 36, WIDTH_BAUD_MENU_ITEM, HEIGHT_ITEM, ITEMTEXT|ITEMENABLED|HIGHCOMP, MUTUALEXCLUDE_BAUD_MENU, &text4800, &text4800, NULL,    NULL, 0 };

struct IntuiText text2400 = 
  { 0, 1, JAM2, CHECKWIDTH, TOP_TEXT_ITEM, NULL, "2400", NULL };

struct MenuItem item2400 =
  { &item4800, 0, 24, WIDTH_BAUD_MENU_ITEM, HEIGHT_ITEM, ITEMTEXT|ITEMENABLED|HIGHCOMP, MUTUALEXCLUDE_BAUD_MENU, &text2400, &text2400, NULL,    NULL, 0 };

struct IntuiText text1200 = 
  { 0, 1, JAM2, CHECKWIDTH, TOP_TEXT_ITEM, NULL, "1200", NULL };

struct MenuItem item1200 =
  { &item2400, 0, 12, WIDTH_BAUD_MENU_ITEM, HEIGHT_ITEM, ITEMTEXT|ITEMENABLED|HIGHCOMP, MUTUALEXCLUDE_BAUD_MENU, &text1200, &text1200, NULL,    NULL, 0 };

struct IntuiText text300 = 
  { 0, 1, JAM2, CHECKWIDTH, TOP_TEXT_ITEM, NULL, "300", NULL };

struct MenuItem item300 =
  { &item1200, 0, 0, WIDTH_BAUD_MENU_ITEM, HEIGHT_ITEM, ITEMTEXT|ITEMENABLED|HIGHCOMP, MUTUALEXCLUDE_BAUD_MENU, &text300, &text300, NULL,    NULL, 0 };
...
struct MenuItem itemPLATOMode =
  { &itemsep1, 0, 0, WIDTH_TERMINAL_MENU_ITEM, HEIGHT_ITEM, ITEMTEXT|ITEMENABLED|HIGHCOMP|COMMSEQ|MENUTOGGLE|CHECKIT|CHECKED, 0, &textPLATOMode, &textPLATOMode, 'T',    NULL, 0 };
