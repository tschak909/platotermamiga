...
static struct MenuItem itemRTSCTS =
  { NULL, 0, 156, WIDTH_BAUD_MENU_ITEM, HEIGHT_ITEM, ITEMTEXT|ITEMENABLED|HIGHCOMP|MENUTOGGLE|CHECKIT|CHECKED, 0, &textRTSCTS, &textRTSCTS, NULL,    NULL, 0 };
...
static struct MenuItem itemPLATOMode =
  { &itemHangUp, 0, 0, WIDTH_TERMINAL_MENU_ITEM, HEIGHT_ITEM, ITEMTEXT|ITEMENABLED|HIGHCOMP|COMMSEQ|MENUTOGGLE|CHECKIT, 0, &textPLATOMode, &textPLATOMode, 'T',    NULL, 0 };
